...
<body>
    ...
    // Função para exibir todas as inscrições
    function exibirInscricoes($connection)
    {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<td>';
                echo '<form id="aprovar_inscricao" action="aprovar_inscricao.php" method="POST" style="display:inline;">';
                ...
                echo '</form>';
                echo ' | ';
                echo '<form id="editar_inscricao" action="editar_inscricao.php" method="POST" style="display:inline;">';
                echo '<input type="hidden" name="idInscricao" value="' . $row['id_inscricao'] . '">';
                echo '<input type="submit" value="Editar">';
                echo '</form>';
                echo ' | ';
                echo '<form id="excluir_inscricao" action="excluir_inscricao.php" method="POST" style="display:inline;">';
                echo '<input type="hidden" name="idInscricao" value="' . $row['id_inscricao'] . '">';
    ...
    // Exibir as inscrições
    exibirInscricoes($conn);
    ?>

    <button onclick="location.href='adicionar_inscricao.php'">Adicionar Inscrição</button>
    <div id="footer">
