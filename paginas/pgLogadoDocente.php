...
<body>
    ...
    <div id="section">
        ...
        <div class="article">
            <h1></h1>
            <button onclick="location.href='gestao_cursos_docente.php'">Gestão de Cursos</button>
            <p></p>
        </div>
        <div class="article">
            <h1></h1>
            <button onclick="location.href='gestao_inscricoes_docente.php'">Gestão de Inscrições</button>
            <p></p>
        </div>
    </div>
    <div id="footer">
