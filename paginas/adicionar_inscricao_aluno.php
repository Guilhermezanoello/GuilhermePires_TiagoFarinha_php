...
// Consulta para obter o idUtilizador do usuário logado na sessão
...
$queryCursos = "SELECT id_curso, titulo FROM cursos";
...
<body>
    ...
    <form action="processar_inscricao_aluno.php" method="POST">
        ...
        <input type="datetime-local" name="data_inscricao" id="data_inscricao" value="<?php echo $currentDateTime; ?>" readonly required>
