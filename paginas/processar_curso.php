...
if (empty($titulo) || empty($docente) || empty($tipo_curso) || empty($data_inicio) || empty($data_fim) || empty($limite_alunos)) {
    ...
    echo '<meta http-equiv="refresh" content="0; url=adicionar_curso.php">';
    exit;
}
...
if (mysqli_query($conn, $query)) {
    ...
    echo '<meta http-equiv="refresh" content="0; url=gestao_cursos.php">';
    exit;
} else {
    echo "Erro ao adicionar curso: " . mysqli_error($conn);
    echo '<meta http-equiv="refresh" content="0; url=adicionar_cursos.php">';
    exit;
}
