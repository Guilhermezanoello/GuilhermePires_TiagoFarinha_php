...
<body>
    ...
    ?>
            ...
            <form action="atualizar_curso_docente.php" method="POST">
                ...
                <select name="idDocente" id="idDocente">
                    ...
                    $queryUtilizadorLogado = "SELECT idUtilizador, nomeUtilizador FROM utilizador WHERE idUtilizador = $idUtilizadorLogado";
                    $resultDocenteLogado = $conn->query($queryUtilizadorLogado);

                    if ($resultDocenteLogado->num_rows > 0) {
                        while ($rowDocente = $resultDocenteLogado->fetch_assoc()) {
