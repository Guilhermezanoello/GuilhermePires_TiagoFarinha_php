...
// Inclui o arquivo basedados.h para obter a conexão com o banco de dados
include "../basedados/basedados.h";

// Consulta para obter os docentes
$queryDocentes = "SELECT idUtilizador, nomeUtilizador FROM utilizador WHERE tipoUtilizador = 2";
